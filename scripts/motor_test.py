...
def motor_test():
    try:
        ...
        Motor1.TurnStep(Dir='forward', steps=100, stepdelay = 0.0005)
        time.sleep(0.01)
        Motor1.TurnStep(Dir='backward', steps=100, stepdelay = 0.0005)
        Motor1.Stop()
        ...
        Motor2.TurnStep(Dir='forward', steps=100, stepdelay=0.0005)
        time.sleep(0.01)
        Motor2.TurnStep(Dir='backward', steps=100, stepdelay=0.0005)
        Motor2.Stop()
    ...
    def SetMicroStep(self, mode, stepformat):
        ...
        (1) mode
            ...
            'software' :    Use software to control microstep pin levels
                Need to put all HW switches to 0
        (2) stepformat
